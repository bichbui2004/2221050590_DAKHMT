...
<body>
    <div class="container">
    <form action="index.php?page_layout=themtaikhoan" method="post">   
        ...
        <?php
            ...
            if(!empty($_POST["ten-dang-nhap"])&&
                ...
                !empty($_POST["vai-tro"])){
                    ...
                    $sql = "INSERT INTO `nguoi_dung`(`mat_khau`, `ten_dang_nhap`, `id_quyen`,  `ho_ten`, `email`, `so_dien_thoai`) VALUES ('$password', '$tenDangNhap','$vaiTro','$hoTen','$email','$soDienThoai')";
